    ...
    <div className="min-h-screen bg-[#191414] text-white overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-[#191414] via-[#191414]/90 to-[#191414]">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          <div className="mb-8">
            <h1 className="text-6xl md:text-8xl font-black mb-6 text-white drop-shadow-2xl" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>
              Cheroor Tea Stall
            </h1>
          ...
          <div className="flex items-center justify-center gap-4 text-[#1DB954] mb-12">
            <Clock size={24} />
            <span className="text-lg font-bold text-white">Open every night • 9 PM to 3 AM</span>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-4 text-white" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>
            ...
            {menuItems.map((item, index) => (
              ...
              >
                <CardContent className="p-4">
                  ...
                  <h3 className="font-black text-lg mb-1 text-white group-hover:text-[#1DB954] transition-colors duration-300" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>
                    {item.name}
                  </h3>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-[#1DB954]/10 to-[#1DB954]/5">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-black mb-2 text-white" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>We're Night Owls Too</h2>
              <p className="text-xl text-white font-semibold">
                Open every night from <span className="text-[#1DB954] font-bold">9 PM to 3 AM</span>
              </p>
            </div>
          </div>
          <p className="text-lg text-white font-medium max-w-2xl mx-auto">
            Whether you're cramming for exams, having late-night discussions, or just need a cozy spot to unwind, 
            we've got you covered with fresh snacks and hot beverages.
          </p>
        </div>
      </section>
              ...
              <Card className="bg-[#181818] border-none p-8">
                <CardContent className="p-0">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-black mb-2 text-white" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>Call Us</h3>
                      <p className="text-white font-medium">Got questions? Give us a ring!</p>
                    </div>
                  </div>
                  <a 
                    href="tel:0123456789" 
              ...
              <Card className="bg-[#181818] border-none p-8">
                <CardContent className="p-0">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-black mb-2 text-white" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>Location</h3>
                      <p className="text-white font-medium">Easy to find, hard to leave</p>
                    </div>
                  </div>
                  <Button 
                    asChild
                  ...
                  >
                    <a href="https://maps.app.goo.gl/Agj6PyYvCvdkj2UL8" target="_blank" rel="noopener noreferrer">
            ...
            <CardContent className="p-8">
              <div className="h-80 flex items-center justify-center bg-[#282828] rounded-lg mb-6">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-black mb-2 text-white" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>Cheroor Nights Playlist</h3>
                  <p className="text-white font-medium">Spotify embed coming soon...</p>
                </div>
              </div>
              <p className="text-white font-medium text-sm">
                The perfect soundtrack for your study breaks and midnight conversations. 
                Mix of chill beats, indie favorites, and campus classics.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <footer className="py-12 px-6 bg-[#0a0a0a] border-t border-[#282828]">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl font-black mb-4 text-[#1DB954]" style={{ fontFamily: "'PolySans Bulky', sans-serif" }}>Cheroor Tea Stall</h3>
